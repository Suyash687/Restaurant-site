...
const Navbar = () => {
  ...
  <nav className="app__navbar">
    ...
    <div className="app__navbar-smallscreen">
      <GiHamburgerMenu color="#ffff" fontSize={27} cursor="pointer" onClick={() =>{setToggleMenu(true);}}/>

      {toggleMenu && (<div className="app__navbar-smallscreen-overlay flex__center slide-bottom">
        <MdOutlineRestaurantMenu className="overlay-screen" fontSize={27} onClick={() =>{setToggleMenu(false);}}/>
